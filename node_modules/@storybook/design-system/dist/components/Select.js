...
var SelectWrapper = _styledComponents["default"].span(_templateObject12(), _styles.spacing.borderRadius.small, Arrow, _styles.color.mediumdark, Selector, _styles.color.border, Selector, _styles.color.primary, function (props) {
  ...
  return props.appearance === 'tertiary' && (0, _styledComponents.css)(_templateObject14(), Selector, _styles.color.darkest, Arrow);
}, function (props) {
  return props.icon && (0, _styledComponents.css)(_templateObject15(), Selector, Selector, SelectIcon, _styles.color.mediumdark, Selector, SelectIcon, _styles.color.darker);
}, function (props) {
  return props.error && (0, _styledComponents.css)(_templateObject16(), Selector, _styles.color.negative, _styles.color.negative, Selector, SelectIcon, _animation.jiggle, _styles.color.negative);
});
...
var Select = function Select(_ref2) {
  var id = _ref2.id,
    ...
    value: 'loading'
      ...
      value = _ref2$value === void 0 ? 'loading' : _ref2$value,
      ...
      _ref2$inProgress = _ref2.inProgress,
      inProgress = _ref2$inProgress === void 0 ? false : _ref2$inProgress,
