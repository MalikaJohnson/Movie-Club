...
exports["default"] = exports.validPlacements = void 0;
...
function WithTooltip(_ref2) {
  var tagName = _ref2.tagName,
      ...
      portalContainer = _ref2.portalContainer,
      tooltipZIndex = _ref2.tooltipZIndex,
      props = (0, _objectWithoutProperties2["default"])(_ref2, ["tagName", "trigger", "closeOnClick", "placement", "modifiers", "hasChrome", "tooltip", "children", "startOpen", "delayHide", "onVisibilityChange", "portalContainer", "tooltipZIndex"]);
...
var placementVariations = ['start', 'end'];
var validPlacements = ['auto', 'top', 'right', 'left', 'bottom'].flatMap(function (placement) {
  return [placement].concat((0, _toConsumableArray2["default"])(placementVariations.map(function (variation) {
    return "".concat(placement, "-").concat(variation);
  })));
});
...
WithTooltip.propTypes = {
  ...
  placement: _propTypes["default"].oneOf(validPlacements),
  ...
  portalContainer: _propTypes["default"].node,
  tooltipZIndex: _propTypes["default"].number
};
