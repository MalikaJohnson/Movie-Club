...
export declare function TableOfContentsItems({ className, currentPath, isTopLevel, items, setMenuOpenStateById, ...rest }: TableOfContentsItemsProps): JSX.Element;
export declare namespace TableOfContentsItems {
    var defaultProps: {
        className: string;
    };
}
export {};
//# sourceMappingURL=TableOfContentsItems.d.ts.map