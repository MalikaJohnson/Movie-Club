...
var Description = _styledComponents["default"].div(_templateObject6(), _styles.typography.size.s1, _styles.typography.weight.regular, _styles.color.mediumdark, _styles.typography.size.s2);

var Input = _styledComponents["default"].input.attrs({
  type: 'radio'
})(_templateObject7(), LabelText, LabelText, _styles.color.mediumdark, LabelText, function (props) {
...
var RadioWrapper = _styledComponents["default"].div(_templateObject8());
...
var Radio = function Radio(_ref) {
  var id = _ref.id,
      ...
      props = (0, _objectWithoutProperties2["default"])(_ref, ["id", "appearance", "label", "description", "error", "hideLabel", "value", "className"]);
