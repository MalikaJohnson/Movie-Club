...
var Image = _styledComponents["default"].div(_templateObject(), function (props) {
  ...
  return !props.src && (0, _styledComponents.css)(_templateObject5(), !props.isLoading && '#37D5D3');
});

var LoadingIcon = (0, _styledComponents["default"])(_Icon.Icon)(_templateObject6(), function (props) {
  return props.type === AvatarType.USER ? -2 : -3;
}, function (props) {
  return props.type === AvatarType.USER ? 100 : 80;
}, function (props) {
  return props.type === AvatarType.USER ? 100 : 80;
}, _styles.color.medium, _animation.glow); // prettier-ignore

var Initial = _styledComponents["default"].div(_templateObject7(), _styles.color.lightest, _styles.typography.size.s2, sizes.medium, function (props) {
  return props.size === "tiny" && (0, _styledComponents.css)(_templateObject8(), _styles.typography.size.s1 - 2, sizes.tiny);
}, function (props) {
  return props.size === "small" && (0, _styledComponents.css)(_templateObject9(), _styles.typography.size.s1, sizes.small);
}, function (props) {
  return props.size === "large" && (0, _styledComponents.css)(_templateObject10(), _styles.typography.size.s3, sizes.large);
});
/**
...
var Avatar = function Avatar(_ref) {
  var _ref$isLoading = _ref.isLoading,
      ...
      props = (0, _objectWithoutProperties2["default"])(_ref, ["isLoading", "username", "src", "size", "type"]);
